...
export class RecipeIconComponent implements OnInit, OnChanges {
  ...
  seeIfValidRecipe() {
    if (this.recipe.constructor !== Object) {
      ...
      return false;
    } else if (typeof this.recipe.Recipe.preptime_seconds === 'undefined') {
      return false;
    } else if (isNaN(this.recipe.Recipe.preptime_seconds)) {
      return false;
    } else if (typeof this.recipe.Recipe.cooktime_seconds === 'undefined') {
      return false;
    } else if (isNaN(this.recipe.Recipe.cooktime_seconds)) {
      return false;
